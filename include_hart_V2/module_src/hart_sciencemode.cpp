...
#include <scicos_block4.h>
    void rt_sciencemode(scicos_block *block,int flag);
...
int init_sciencemode(scicos_block *block){
...
void inout_sciencemode(scicos_block *block){
...
void end_sciencemode(scicos_block *block){
  struct  oScience* comdev = (struct oScience *) (*block->work);
  int error;
...
void rt_sciencemode(scicos_block *block,int flag)
{
  if ((flag==1)&&(block->nevprt==1)){          /* get input */
    inout_sciencemode(block);
  }
  else if (flag==5){     /* termination */
    end_sciencemode(block);
  }
  else if (flag ==4){    /* initialisation */
    init_sciencemode(block);
  }
}
